...
The data are not actually clustered, or at least do not visually appear to be, and thus there is some randomness to the KMC results
...
The data are distinctly clustered, and so the results of KMC are always the same
